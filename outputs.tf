...
output "route_servers_hub_routing_preference" {
  ...
  value       = { for k, v in azurerm_route_server.route_servers : k => v.hub_routing_preference }
}
output "route_servers_location" {
  ...
  value       = { for k, v in azurerm_route_server.route_servers : k => v.location }
}
output "route_servers_name" {
  description = "Map of name values across all route_servers, keyed the same as var.route_servers"
  value       = { for k, v in azurerm_route_server.route_servers : k => v.name }
}
output "route_servers_public_ip_address_id" {
  ...
  value       = { for k, v in azurerm_route_server.route_servers : k => v.public_ip_address_id }
}
output "route_servers_resource_group_name" {
  ...
  value       = { for k, v in azurerm_route_server.route_servers : k => v.resource_group_name }
}
output "route_servers_routing_state" {
  ...
  value       = { for k, v in azurerm_route_server.route_servers : k => v.routing_state }
}
output "route_servers_sku" {
  description = "Map of sku values across all route_servers, keyed the same as var.route_servers"
  value       = { for k, v in azurerm_route_server.route_servers : k => v.sku }
}
output "route_servers_subnet_id" {
  ...
  value       = { for k, v in azurerm_route_server.route_servers : k => v.subnet_id }
}
output "route_servers_tags" {
  description = "Map of tags values across all route_servers, keyed the same as var.route_servers"
  value       = { for k, v in azurerm_route_server.route_servers : k => v.tags }
}
output "route_servers_virtual_router_asn" {
  ...
  value       = { for k, v in azurerm_route_server.route_servers : k => v.virtual_router_asn }
}
output "route_servers_virtual_router_ips" {
  ...
  value       = { for k, v in azurerm_route_server.route_servers : k => v.virtual_router_ips }
}
